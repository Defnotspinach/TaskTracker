    ...
    <div className="min-h-screen bg-gradient-to-br from-violet-50 via-white to-indigo-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Start tracking your tasks today</p>
        </div>
        ...
        <div className="card p-6">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div>
              ...
              <input {...register('name')} className="input" placeholder="Your full name" autoComplete="name" />
        ...
        <p className="text-center text-sm text-gray-500 dark:text-gray-400 mt-4">
          ...
          <Link to="/signin" className="text-violet-600 dark:text-violet-400 font-medium hover:underline">Sign in</Link>
        </p>
      </div>
    </div>
  );
